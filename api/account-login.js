...
// convex/_generated/api -- that directory is gitignored (regenerated by
// `convex dev`), so it's not present on the Vercel build machine.
...
export default async function handler(req, res) {
  ...
  let result;
  try {
    result = await client.mutation('auth:signIn', {
