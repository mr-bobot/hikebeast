...
// Vendored from node_modules/convex/dist/browser.bundle.js (convex@1.37.0).
// Loaded as a non-module <script>, the IIFE's `var convex = (...)` becomes
// `window.convex` -- giving us window.convex.ConvexClient, ConvexHttpClient, etc.
// To upgrade: bump `convex` in package.json, then re-run `cp` above.
